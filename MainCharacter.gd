...
func _ready():
	...
	animations = [
		...
		load("res://Character/AnimationSprite/front.png"),
		load("res://Character/AnimationSprite/left.png"),
		load("res://Character/AnimationSprite/right.png"),
		load("res://Character/AnimationSprite/up_left.png"),
		load("res://Character/AnimationSprite/up_right.png"),
